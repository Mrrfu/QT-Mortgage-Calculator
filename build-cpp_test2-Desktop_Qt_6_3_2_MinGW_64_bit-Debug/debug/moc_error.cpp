...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_error_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_error_t qt_meta_stringdata_error = {
    {
        QT_MOC_LITERAL(0, 5),  // "error"
        QT_MOC_LITERAL(6, 21),  // "on_btn_cancel_clicked"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 19)   // "on_btn_sure_clicked"
    },
    "error",
...
const QMetaObject error::staticMetaObject = { {
    ...
    qt_meta_stringdata_error.offsetsAndSizes,
    qt_meta_data_error,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_error_t
